...
export const services2 = [
  {
    ...
    title: "Business ",
    text: "Business studies involves understanding various aspects of business, including data analysis, statistical models, and technological tools, to guide decision-making and improve outcomes.",
    categories: [
  ...
  },
  {
    ...
    categories: ["BSc Nursing", "Public Health", "Health And Care Management"],
    delay: "0.15s",
  ...
  },
  {
    ...
    text: "Information technology courses equip students with key skills in computer systems, software development, networking, and cybersecurity for careers in the fast-evolving tech industry.",
    categories: [
